    ...
    <form class="form-horizontal" method="post" action="../../actions/events/createEvent.php">
      ...
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <div class="input-group">
              ...
              <input id="EventTitle" name="EventTitle" type="text" placeholder="Event Title" class="form-control input-md" value={if $create==0}{$info.title}{/if}>
            </div>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-md-2  col-xs-4">
            <input id="Street" name="address" type="text" placeholder="Street" class="form-control input-md" value={if $create==0 }{$info.address}{/if}>
          </div>
          <div class="col-md-2 col-xs-4">
            <input id="ZipCode" name="ZipCode" type="text" placeholder="Zip-Code" class="form-control input-md" value={if $create==0}{$info.zip_code}{/if}>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-md-4">
            <div class="input-group">
              ...
              <input class="form-control" id="date" name="date" placeholder="MM/DD/YYYY" type="text"  value={if $create==0}{$info.date}{/if}>
          ...
          <div class="col-md-4">
            <div class="input-group">
              <div class="input-group-addon">
               ...
               <input id="EventTime" name="EventTime" type="time" placeholder="EventTime" class="form-control input-md" value={if $create==0}{$info.time}{/if}>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              <div class="input-group">
                ...
                <input id="EventPrice" name="EventPrice" type="number" placeholder="EventPrice" class="form-control input-md" value={if $create==0}{$info.price}{/if}>
              </div>
            </div>
          </div>
          <div class="form-group">
